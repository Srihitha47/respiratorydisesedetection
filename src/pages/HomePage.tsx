  ...
  return (
    <div className="min-h-screen pt-16">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_hsl(200_100%_55%_/_0.08),_transparent_60%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,_hsl(180_80%_50%_/_0.05),_transparent_60%)]" />
        <div className="relative container py-24 md:py-36 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass text-xs font-medium text-primary mb-6 animate-fade-in">
            <span className="w-1.5 h-1.5 rounded-full bg-primary animate-pulse" />
            Multimodal AI · Deep Learning · Real-time Analysis
          </div>
          <h1 className="font-display text-4xl md:text-6xl lg:text-7xl font-bold text-foreground mb-6 animate-fade-in" style={{ animationDelay: "0.1s" }}>
            Breathe<span className="text-gradient">Smart</span>
          </h1>
          <p className="text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto mb-10 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            Advanced AI system analyzing chest X-rays and lung sounds for accurate disease detection, severity assessment, and personalized health guidance.
          </p>
          <div className="flex flex-wrap justify-center gap-4 animate-fade-in" style={{ animationDelay: "0.3s" }}>
            ...
            <Link
              to="/chatbot"
              className="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl glass text-foreground font-semibold text-lg hover:bg-accent transition-colors"
            >
              💬 AI Assistant
            </Link>
          </div>
      ...
      <section className="container py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={stat.label} className="glass rounded-2xl p-6 text-center hover:shadow-card-hover transition-shadow">
      ...
      <section className="container py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <div key={f.title} className="glass rounded-2xl p-6 hover:shadow-card-hover hover:-translate-y-1 transition-all duration-300">
      ...
      <section className="container py-12 pb-20">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {DISEASES.map((d) => (
            <div key={d.name} className="glass rounded-2xl p-6 hover:-translate-y-1 hover:shadow-card-hover transition-all duration-300">
